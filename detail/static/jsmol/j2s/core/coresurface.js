...
this.checkFileExists (files[j] = list.get (ptf++), eval);
...
}}}if (stype == null) this.checkFileExists (filename, eval);
...
Clazz_defineMethod (c$, "checkFileExists", 
 function (filename, eval) {
if (this.e.chk || filename.startsWith ("cache://")) return;
...
function (property, index) {
if (property === "jvxlFileData") return J.jvxl.data.JvxlCoder.jvxlGetFileVwr (null, this.jvxlData, null, this.params.title, "", true, index, null, null);
